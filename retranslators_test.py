...
NEIGH_NUM = 3 # метрика числа cocедей у люстры, на самом деле их получается примерно NEIGH_NUM*2 + 1
              # если NEIGH_NUM = 0, то соседей 2, люстры выстроены в кольцо
TRANSMISSION_PROBABILITY = 0.99 # вероятность передачи между люстрами
